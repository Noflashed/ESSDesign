...
const builders = [{id:'builder-test', name:'Test Builder', projects:[{id:'project-test', name:'Test Project', designFolderId:'design-folder', scaffoldEntity:'Erect Safe Scaffolding'}]}];
