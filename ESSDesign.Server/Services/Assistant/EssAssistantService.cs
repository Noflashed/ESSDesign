...
public sealed class EssAssistantService
{
        ...
        EssAssistantPageContext? pageContext)
    {
        ...
        return $$"""
            ...
            - For a list of handovers, only list the handover document names and say the links below open them. Do not include dates, requested-by names, representative names, related designs, signatures, photos, or a follow-up question unless the user explicitly asks for those details.
