...
namespace ESSDesign.Server.Services
{
    public class EmailService
    {
        ...
        public async Task SendUserInviteAsync(string recipientEmail, string inviterName)
        {
            if (string.IsNullOrWhiteSpace(recipientEmail))
            {
                _logger.LogWarning("Invite email skipped because recipient email was empty");
                return;
            }

            if (_resend == null)
            {
                _logger.LogWarning("Email service is not configured (missing Resend:ApiKey). Skipping invite email.");
                return;
            }

            var signUpLink = $"{_frontendUrl.TrimEnd('/')}/?auth=signup&email={System.Web.HttpUtility.UrlEncode(recipientEmail)}";
                ...
                <table role=""presentation"" cellpadding=""0"" cellspacing=""0"" border=""0"" width=""620"" style=""max-width:620px;width:100%;background:#ffffff;border-radius:12px;overflow:hidden;"">
                    <tr>
                        <td align=""center"" style=""background-color:#1a1a2e;padding:36px 32px 32px;"">
                            ...
                            <h1 style=""color:#ffffff;font-size:21px;font-weight:600;letter-spacing:-0.2px;margin:0 0 6px;"">You've Been Invited</h1>
                            <p style=""color:#9a9ab0;font-size:13px;margin:6px 0 0;font-weight:400;"">Create your ESS Design account to access the document system</p>
                        </td>
                    </tr>
                    <tr>
                        <td style=""padding:32px;"">
                            <p style=""font-size:14px;color:#4a5568;margin:0 0 24px;line-height:1.7;"">
                                <strong style=""color:#2d3748;"">{safeInviter}</strong> has invited <strong style=""color:#2d3748;"">{safeRecipient}</strong> to join ESS Design.
                            </p>
                            ...
                            <table role=""presentation"" cellpadding=""0"" cellspacing=""0"" border=""0"" width=""100%"" style=""background-color:#f7fafc;border:1px solid #e2e8f0;border-radius:8px;margin:0 0 24px;"">
                                <tr>
                                    <td style=""padding:14px 20px;border-bottom:1px solid #e2e8f0;"">
                                        <p style=""font-size:10px;text-transform:uppercase;letter-spacing:0.8px;color:#a0aec0;font-weight:600;margin:0 0 3px;"">Invited Email</p>
                                ...
                                <tr>
                                    <td style=""padding:14px 20px;"">
                                        ...
                                        <p style=""font-size:15px;color:#2d3748;font-weight:500;margin:0;"">Use the button below to create your account</p>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <p style=""font-size:11px;text-transform:uppercase;letter-spacing:1px;color:#a0aec0;font-weight:600;margin:0 0 20px;text-align:center;"">Get Started</p>
                                        ...
                                        <table role=""presentation"" cellpadding=""0"" cellspacing=""0"" border=""0"">
                                            <tr>
                                                <td align=""center"" style=""border-radius:100px;background-color:#FF6B35;"">
                                                    <a href=""{safeLink}"" style=""display:inline-block;padding:16px 32px;border-radius:100px;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif;font-size:14px;font-weight:600;color:#ffffff;text-decoration:none;min-width:180px;text-align:center;"">Create your account</a>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
