...
builder.Services.AddSingleton<IPreStartVoiceRegistry, PreStartVoiceRegistry>();
builder.Services.AddScoped<PreStartDialogueService>();
builder.Services.AddScoped<PreStartTurnService>();
builder.Services.AddSingleton<PreStartVoicePersistence>();
builder.Services.AddHostedService(sp => sp.GetRequiredService<PreStartVoicePersistence>());
